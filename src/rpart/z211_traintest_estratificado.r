...
particionar(dataset, division = c(7, 3), agrupa = "clase_ternaria", seed = 675029) # Cambiar por la primer semilla de cada uno !
...
#Aciertos (BAJA+2):  217
#> cat("Ganancia en testing (normalizada): ", ganancia_test_normalizada, "\n")
#Ganancia en testing (normalizada):  51970000