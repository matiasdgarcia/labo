...
PARAM  <- list()
PARAM$experimento <- "FE7311_v2"

PARAM$exp_input  <- "DR7211_v2"
...
PARAM$RandomForest$semilla  <- 675029    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 675029   # cambiar por la propia semilla
