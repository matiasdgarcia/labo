...
PARAM  <- list()
PARAM$experimento  <- "DR7211_v2"

PARAM$exp_input  <- "CA7111_v2"

PARAM$variables_intrames  <- TRUE   # atencion esto esta en TRUE

#valores posibles  "ninguno" "rank_simple" , "rank_cero_fijo" , "deflacion"
PARAM$metodo  <- "ninguno" # aconsejan ninguno https://docs.google.com/presentation/d/1RNlDbJpneocsuQ93-VEYaAAg07spkW-hQboykPJF1bk/edit#slide=id.g1e2d97d7bfe_23_1451
...
AgregarVariables_IntraMes  <- function( dataset )
{
  ...
  # las que mejor anduvieron en https://github.com/waldof86/labo2023FEManual/blob/master/Scripts/09_R_Ex30Var/k621_DR_corregirdatadriftingrevisores.r#L34
