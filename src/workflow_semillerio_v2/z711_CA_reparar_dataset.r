...
PARAM <- list()
PARAM$experimento <- "CA7111_v2"
PARAM$dataset <- "./datasets/competencia_2023.csv.gz"

PARAM$metodo <- "MachineLearning" # ML recomendado por exp y revisores en Labo, ver slide https://docs.google.com/presentation/d/1RNlDbJpneocsuQ93-VEYaAAg07spkW-hQboykPJF1bk/edit#slide=id.g1e2d7bf3597_0_325
