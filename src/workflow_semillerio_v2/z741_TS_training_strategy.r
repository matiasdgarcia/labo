...
PARAM  <- list()
PARAM$experimento <- "TS7411_v2"

PARAM$exp_input  <- "FE7311_v2"

# me salteo los meses duros de pandemia, pero llego hasta 201907 en training
# entreno en 18 meses

# Reemplazo por nuestro mejor experimento, wf4:

PARAM$future       <- c( 202109 )
PARAM$final_train  <- c( 202107, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909 )
...
PARAM$train$testing      <- c( 202107, 202106 ) # no sé...

# Atencion  0.4  de  undersampling de la clase mayoritaria,  los CONTINUA
PARAM$train$undersampling  <- 0.05   # según zulip profesor

PARAM$train$semilla  <- 675029  # cambiar por su propia semilla  !!!
